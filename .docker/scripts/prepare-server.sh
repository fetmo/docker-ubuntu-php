...
rm -rf /tmp/ioncube
cp /opt/docker/scripts/files/00-ioncube.ini /etc/php/7.2/apache2/conf.d/00-ioncube.ini
cp /opt/docker/scripts/files/00-ioncube.ini /etc/php/7.2/cli/conf.d/00-ioncube.ini
